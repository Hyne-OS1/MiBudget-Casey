...
export function CategoriesContextProvider({
  ...
  // If the category already exists the amount of the category will be adjusted
    ...
    setCategories((prev) => {
      ...
      arr.forEach((c) => {
        ...
        if (c.amount > 0) {
          ...
          // if the amount is zero or less then that means the category is not being used therefore set is used for that category in available categories array to false
